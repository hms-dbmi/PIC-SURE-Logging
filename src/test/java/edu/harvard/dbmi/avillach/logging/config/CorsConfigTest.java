...
@SpringBootTest(webEnvironment = RANDOM_PORT, properties = {
    ...
    "picsure.logging.allowed-origin=https://example.com"
})
class CorsConfigTest {
    ...
    void allowedOriginIsEchoedOnPreflight() {
        assertThat(preflight("https://example.com").getHeaders().getAccessControlAllowOrigin())
    ...
    /**
     * Pins the filter ordering. CorsFilter (order 0) must answer the preflight before
     * ApiKeyAuthFilter (order 1) sees it, exactly as Javalin's CORS plugin did. If this
     * regresses, every browser preflight against /audit gets a 401.
     */
    @Test
