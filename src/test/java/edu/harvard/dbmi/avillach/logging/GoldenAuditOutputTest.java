...
/**
 * Pins the exact audit JSON emitted to stdout. Splunk field extractions depend on it.
 * This test must survive the Javalin -> Spring Boot rewrite unchanged apart from the
 * config type it constructs.
 */
class GoldenAuditOutputTest {
    ...
    void metadataOmittedEntirelyWhenOnlySessionIdPresent() throws Exception {
        service.logEvent(
            new AuditEvent("TEST", null, null, null, null, null, Map.of("session_id", "sid-only"), null), null, null);
    ...
    void stringsTruncatedAtExactly2000Chars() throws Exception {
        RequestInfo request = new RequestInfo(
            null, null, "x".repeat(3000), null, null, null, null, null, null, null, null, null, null);
    ...
    void callerAndErrorMapArePreserved() throws Exception {
        service.logEvent(
            new AuditEvent("TEST", null, null, "PYTHON_ADAPTER", null, null, null,
                Map.of("origin", "psama", "message", "Internal error")),
            null, null);
