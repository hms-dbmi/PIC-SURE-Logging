...
public class WebConfig {
    ...
    /**
     * Order 0: preflight is answered and short-circuited before ApiKeyAuthFilter (order 1),
     * mirroring Javalin, where the CORS plugin ran ahead of app.before("/audit").
     * An OPTIONS preflight therefore never needs an API key.
     */
    @Bean
