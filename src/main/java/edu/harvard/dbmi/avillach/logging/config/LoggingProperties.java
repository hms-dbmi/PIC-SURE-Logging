...
/**
 * Binds the frozen environment variable names via placeholders in application.yml.
 * There is deliberately no {@code port} component: Spring owns {@code server.port}.
 *
 * <p>Validation lives in the compact constructor rather than in JSR-380 annotations,
 * matching the gateway's GatewaySecurityProperties style.
 */
